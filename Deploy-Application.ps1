...
Try {
	...
	[string]$appVersion = 'April 2022'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '04/7/2022'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		# install new version
		Execute-Process -Path "$dirFiles\Fusion 360 Admin Install.exe" -Parameters '--quiet' -WaitForMsiExec:$true -WindowStyle 'Hidden'
		# remove any and all old versions (see https://damassets.autodesk.net/content/dam/autodesk/docs/pdfs/Advanced_Fusion360_Lab_Installation_Instructions_en-GB.pdf, for why it needs to be after the new install)
		Execute-Process -Path "$dirFiles\Fusion 360 Admin Install.exe" -Parameters '--process uninstall --purge-incomplete --quiet' -WaitForMsiExec:$true -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$dirFiles\Fusion 360 Admin Install.exe" -Parameters '--process uninstall --quiet' -WaitForMsiExec:$true -WindowStyle 'Hidden'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbN3cyppKe9lYu
# naVVnWB+YgdTr//gvK0jBPM+i2u0L6CCH9IwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# DQEJBDEiBCDpLCyz43/HQQHUM18V/3Ba+qRtoEIVEbJRy5Mbtb66rzANBgkqhkiG
# 9w0BAQEFAASCAYAsY4rImFmnbjw5XZPuQkwAs2gkBhPfmRBdhX+pu/Zie8NF7HNo
# GfTBqsl9Tr1CK3dtVvG9YobgN3f/RROBaTiqeLye11HlGlY+jPuf0AEmCId7a1ZJ
# qPqn0fZL6xrjrYqGIIexjjL3OgQnja3QO2T/aPxNokwDLH3iYieoU6hawDtZRujd
# QCEiTxiZ7I6hNiM5A7S3x9pe6eOwmhvbL6VwzIO3tcmfPJM8AwA9qCx7VYYBnb55
# fs5o1fMBJNJn7ISzcl3MKPv5lk83jZVLS26Ov4Ht/M392tqClN+gx0vbHLd5cGbY
# TpKIaj2Kc2GT2CSufLqCPgfYRtMhD1FrTBd4g8SF1ZDMoeI7hnFnL+YlDm1KahZx
# vd6Ff2gQNIFe8SNgE7oDi8J8d+nFXemQf+0kwf8NslXZykE2WZfcw8srARYuIqo3
# TR0FEkPGserY2oZ1QJOhnTgQHqXpJXPAzBKU9gmmD1cN6cUIYQPldFTwvuh6SBrs
# JGueUHh0Hy00RAChggNMMIIDSAYJKoZIhvcNAQkGMYIDOTCCAzUCAQEwgZIwfTEL
...
# hvcNAQkFMQ8XDTIyMDQwNzE1NTExNFowPwYJKoZIhvcNAQkEMTIEMMcnYUC6ERI8
# oUqgqS9MfYLaULqSh4iFrNNreE21Iw3rcSiVQ5JFrpDkfTzRwwY3zjANBgkqhkiG
# 9w0BAQEFAASCAgAA7aG/ABw71FDLk2u72BSfZIjACv/knYu93R7aEqeeeo41SZCa
# ughvJz1C6G2zbq+DIQVC7QIawRhzuZwPbLYNHGelRxhZ8wESQCfcIsR3nJcaderb
# mqxoLCqNsQeRtMOgCP8csyuFMdJHz5vRz0NPzYfaDdrnj9Gu5Aqqbst11GgF5QO8
# QB5mb53JghbqTb2PryLlfWh5QECmf3xl3FqDweFUBXiB/yxuq/GpB9TwiAtaAh8b
# u0AkK7XbgZpGsqNv6jYin6kGjQeXqJbQXuG1+HkBSymhh7f3/yrQjHVRAWbdLDP/
# PI4DoGBp0KvRfm4xlFodoEXfEOB6IN14NURZikPzxUJ97nBtQ9QMI3m5jr6H1Rhv
# DzO9hHJCtIlq0veoqnTWpRHIhTfvECkYWtAs+8nB+BqTMfMJe48dhd9xue3VAT5k
# q+QUyLSBUJUVkmLBu2ptxjTf6Ln0ZBtApKwu6d+t1FYPL7rwfqY2aIgivzYditI9
# ArUYhEM/XAhttmu/mKif9ucsNL7sNmWOSXVT0ezQMleTEosdno5RIgweHhzVeoa7
# y3B85DQXiYvEr+dVLCrFzHbC+HIsK5rB/EZbyMmP5v97MkFv92Zno+02OFETuE4F
# 7hHnbYpZ/t4NOpPLOJUAkk6c6OPvjXQtju+kUrXlYmz4v3Sz7ZziS4ZJvw==
